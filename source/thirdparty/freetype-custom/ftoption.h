...
// #warning "Using custom Freetype options!" // Yes, it works (Alex)
...
FT_BEGIN_HEADER
   ...
   *
   */
// #define FT_CONFIG_OPTION_ENVIRONMENT_PROPERTIES // Nope (Alex)
...
#define FT_CONFIG_OPTION_INLINE_MULFIX
   ...
   */
//#define FT_CONFIG_OPTION_USE_LZW // Nope (Alex)
   ...
   */
//#define FT_CONFIG_OPTION_USE_ZLIB // Nope (Alex)
...
/* #define FT_CONFIG_OPTION_HVF */
   ...
   */
//#define FT_CONFIG_OPTION_POSTSCRIPT_NAMES // Nope (Alex)
   ...
   */
//#define FT_CONFIG_OPTION_ADOBE_GLYPH_LIST // Nope (Alex)
   ...
   */
//#define FT_CONFIG_OPTION_MAC_FONTS // Nope (Alex)
...
#define FT_CONFIG_OPTION_GUESSING_EMBEDDED_RFORK
   ...
   */
//#define FT_CONFIG_OPTION_INCREMENTAL // Nope (Alex)
...
#define TT_CONFIG_OPTION_EMBEDDED_BITMAPS
   ...
   */
//#define TT_CONFIG_OPTION_COLOR_LAYERS // Nope (Alex)
   ...
   */
//#define TT_CONFIG_OPTION_POSTSCRIPT_NAMES // Nope (Alex)
